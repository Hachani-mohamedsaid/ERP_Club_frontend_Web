...
import { SessionTimeoutGuard } from "../settings/SessionTimeoutGuard";
import { NotificationWatcher } from "../settings/NotificationWatcher";
...
export function AppShell() {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden">
      ...
      <div className="flex flex-1 flex-col overflow-y-auto" style={{ background: "transparent" }}>
        {isImpersonating && (
        ...
        <Topbar />
        <main className="flex-1 space-y-6 px-8 pb-8" style={{ color: "var(--text-primary)" }}>
          <Outlet />
        </main>
      </div>
