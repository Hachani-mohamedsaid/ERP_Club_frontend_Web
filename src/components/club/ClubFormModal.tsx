...
export function ClubFormModal({ title, fields, onClose, onSubmit }: ClubFormModalProps) {
    ...
    >
      ...
      >
        ...
        <motion.button
          type="button"
          disabled={saving}
          onClick={async () => { setSaving(true); try { await onSubmit(values); onClose(); } finally { setSaving(false); } }}
